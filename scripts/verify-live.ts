...
try {
  ...
  console.log(`Mapping model: ${env.MAPPING_PROVIDER === "openai" ? env.OPENAI_MODEL : env.GEMINI_MODEL}`);
  ...
  if (lowConfidence.length) console.log("Selected low-confidence sources:", lowConfidence);
